...
async function onMessageHandler(target, tags, message, self) {
  ...
  */
  ...
  if (messageType == "chat" || messageType == "action") {
    ...
    //let checkTwitchViewBotSoftwareBot = /(t+w+\w*t+c+h+)+\s+(v+i+e+w+\w*\s*b+[o0]+t+\w*)+\s+(s+o+f+t+w+a+r+e+\w*\W*)+\s*(d+o+)+\s+(a+n+y+)+\s*(o+n+l+i+n+e+)*\s+(\w*)+\s+(a+n+y+)+\s+(s+t+r+e+a+m+\w*\W*\w*)+\s+(\W*\d*\W*)+\W*\s*((d+[\s\.\,\-\_\+\=\\\/]*[1i]+[\s\.\,\-\_\+\=\\\/]*s+[\s\.\,\-\_\+\=\\\/]*c+[\s\.\,\-\_\+\=\\\/]*[0o]+[\s\.\,\-\_\+\=\\\/]*r*[\s\.\,\-\_\+\=\\\/]*d*)+\s+\W*\s+(\w+\W*\d+))*/ig.test(message.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, ""));
    ...
    */
    ...
    //let checkDiscordStreamersCommunityBot = /(h+e+y+\W*)+\s+(n+i+c+e+)+\s+(s+t+r+e+a+m+\w*\W*\w*\W*)+\s+(y+\w*)+\s+(s+h+\w*)+\s+(f+o+r+)+\s+(s+u+r+e+)+\s+(j+o+i+n+)+\s+(\w*)+\s+(s+t+r+e+a+m\w*\W*\w*)+\s+(c+o+m+u+n+i+t+y+)+\s+(\w*)+\s+(j+u+s+t+)+\s+(f+o+u+n+d+)+\s+(\w*)+\s+(d+[\s\.\,\-\_\+\=\\\/]*[1i]+[\s\.\,\-\_\+\=\\\/]*s+[\s\.\,\-\_\+\=\\\/]*c+[\s\.\,\-\_\+\=\\\/]*[0o]+[\s\.\,\-\_\+\=\\\/]*r*[\s\.\,\-\_\+\=\\\/]*d*)+\s+(y+e+s+t+e+r+d+a+y+)+\s+([^\n\s]*)+\s+(c+h+e+c+k+)+\s+(i+t+)+\s+(o+u+t+)+/ig.test(message.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig));
    ...
    //  /(t+w+\w*t+c+h+)+\s+(v+i+e+w+\w*\s*b+[o0]+t+\w*)+\s+(s+o+f+t+w+a+r+e+\w*\W*)+\s*(d+o+)+\s+(a+n+y+)+\s*(o+n+l+i+n+e+)*\s+(\w*)+\s+(a+n+y+)+\s+(s+t+r+e+a+m+\w*\W*\w*)+\s+(\W*\d*\W*)+\W*\s*((d+[\s\.\,\-\_\+\=\\\/]*[1i]+[\s\.\,\-\_\+\=\\\/]*s+[\s\.\,\-\_\+\=\\\/]*c+[\s\.\,\-\_\+\=\\\/]*[0o]+[\s\.\,\-\_\+\=\\\/]*r*[\s\.\,\-\_\+\=\\\/]*d*)+\s+\W*\s+(\w+\W*\d+))*/ig.test(message.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")),
    //  /(h+e+y+\W*)+\s+(n+i+c+e+)+\s+(s+t+r+e+a+m+\w*\W*\w*\W*)+\s+(y+\w*)+\s+(s+h+\w*)+\s+(f+o+r+)+\s+(s+u+r+e+)+\s+(j+o+i+n+)+\s+(\w*)+\s+(s+t+r+e+a+m\w*\W*\w*)+\s+(c+o+m+u+n+i+t+y+)+\s+(\w*)+\s+(j+u+s+t+)+\s+(f+o+u+n+d+)+\s+(\w*)+\s+(d+[\s\.\,\-\_\+\=\\\/]*[1i]+[\s\.\,\-\_\+\=\\\/]*s+[\s\.\,\-\_\+\=\\\/]*c+[\s\.\,\-\_\+\=\\\/]*[0o]+[\s\.\,\-\_\+\=\\\/]*r*[\s\.\,\-\_\+\=\\\/]*d*)+\s+(y+e+s+t+e+r+d+a+y+)+\s+([^\n\s]*)+\s+(c+h+e+c+k+)+\s+(i+t+)+\s+(o+u+t+)+/ig.test(message.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig)),
    //  /(d+o+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+((w+a+n+t+)|(w+a+n+a+))+\s+(p+o+p+u+l+a+r+\w*[^\n\s]*)+\s+(b+u+y+)+\s+(f+[o0]+l+[o0]+w+\w*)+\s+(a+n+d+)+\s+(v+i+e+w+\w*)+\s+(\w+)+\s+([^\n\s]+)+/ig.test(message.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig)),
    ...
    let singleMessageSpamBots = [
      ...
      //console.log("Test 2"),
      /(h+e+y+[^\s]*)+\s+(n+i+c+e+)+\s+(s+t+r+e+a+m+[^\s]*)+\s+(y+\w*)+\s+(s+h+\w*)+\s+(f+o+\w*)+\s+(s+u+r+e+)+\s+(j+o+i+n+)+\s+(\w*)\s+(s+t+r+e+a+m+[^\s]*)+\s+(c+o+m+u+n+i+t+y+)+\s+(\w*)\s+(j+u+s+t+)+\s+(f+o+u+n+d+)+\s+(\w*)\s+(d+[\s\.\,\-\_\+\=\\\/]*[1i]+[\s\.\,\-\_\+\=\\\/]*s+[\s\.\,\-\_\+\=\\\/]*c+[\s\.\,\-\_\+\=\\\/]*[0o]+[\s\.\,\-\_\+\=\\\/]*r*[\s\.\,\-\_\+\=\\\/]*d*)+\s+(y+e+s+t+e+r+d+a+y+)+\s+([^\s]*)\s+(c+h*e+[ck]+)+\s+(i+t+)+\s+(o+u+t+)+\s*([^\s]*)/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")),
      //console.log("Test 3"),
      /(d+o+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+(w+a+n+\w+)+\s*(t*o*)*\s*(b*e*c*o*m*e*)*\s+(p+o+p+u+l+a+r+\w*[^\s]*|f+a+m+o+u+s+\W*[^\s]*)+\s+((a+c+t+i+v+e+)+|(r+e+a+l+)+|(b+u+y+)+|(f+r+e+)+|(t+o+p+)+|(b+e+s+t+)+|(c+h+e+a+p+)+|(g+e+t+)+)+\s+((f+[o0]+l+[o0]+w+\w*)|((s*u*b*\s*\-*\s*)*p+r+i+m+e+\w*(\s*\-*\s*s*u*b*)*\w*(\s*\-*\s*s*u*b*)*)|(v+i+e+w+\w*))+\s+(a+n+d+)+\s+((f+[o0]+l+[o0]+w+\w*)|((s*u*b*\s*\-*\s*)*p+r+i+m+e+\w*(\s*\-*\s*s*u*b*)*\w*(\s*\-*\s*s*u*b*)*)|(v+i+e+w+\w*))+\s+(\w+)/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")),
      //console.log("Test 4"),
      ...
      //console.log("Test 6"),
      /(h+e+l+o+[^\s]*)+\s+(i+f+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+(n+e+d+)+\s+(r+e+a+l+)\s+(f+r+e+)+\s+(a+n+d+)+\s+(h+i+[gq]+h+)+\s+(q+u+a+l+i+t+y+)+\s+(s+e+r+v+i+c+e+s*)+\s+(t+\w*)+\s+(i+n+c+r+e+a+s+e+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+((f+[o0]+l+[o0]+w+\w*)|((s*u*b*\s*\-*\s*)*p+r+i+m+e+\w*(\s*\-*\s*s*u*b*)*\w*(\s*\-*\s*s*u*b*)*)|(v+i+e+w+\w*))+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")),
      //console.log("Test 7"),
      ...
      //console.log("Test 10"),
      /(h+e+l+o+[^\s]*)+\s+(i+)+\s+(d+o+)+\s+(g+r+a+p+h+i+c+)+\s+(d+e+s+i+g+n+)+\s+(\w+o+)+\s+(i+f+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+(n+e+d+)+\s+(w+o+r+k+)+\s+(d+o+n+e+)+\s+((l+i+k+e+)+|(l+[ou]+v+e*)+)+\s+(\w+)+\s+(l+o+g+o+[^\s]*)+\s+(b+a+n+e+r+[^\s]*)+\s+(p+a+n+e+l+[^\s]*)+\s+(o+v+e+r+l+a+y+[^\s]*)+\s+(e+t+c+[^\s]*)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")),
      //console.log("Test 11"),
      ...
      //console.log("Test 31"),
      /((p+r+o+m+o+t*e*)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+((c+h+a+n+e+l+s*)+|(s+t+r+[e*a*]*m+i*n*g*e*r*s*)+)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Come stream-promotion ru. Promote your channel, viewers, followers, views, chat bots. Many offers for different platforms. Autostart. Responsive support 24\7
      //console.log("Test 32"),
      ...
      //console.log("Test 36"),
      /(e+v+e+r+y+\s*t+h+i+n+g+)+\s+(i+s+)+\s+([aeiou]+n+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+(h+a+n+d+s*)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Everything is in your hands
      //console.log("Test 37"),
      ...
      //console.log("Test 61"),
      /(r+e+a+l+y+)+\s+(e+n+j+o+y+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+((c+o+n+t+e+n+t+)+|(s+t+r+[e*a*]*m+i*n*g*e*r*s*)+)+\s+(a+n+d+)+\s+(f+i+n+d+)+(\s+i+t+)*\s+(e+n+j+o+y+a+b+l+e+)\s+(t+o+)+\s+(w+a+t+c+h+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // greetings. I really enjoy your content and find it enjoyable to watch. I recommend that you continue your outstanding work. SeemsGood SeemsGood (PART 1)
      //console.log("Test 62"),
      /(r+e+c+o+m+e+n+d+)+\s+(t+h+a+t+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)\s+(c+o+n+t+i+n+u+e+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+((o+u+t+s+t+a+n+d+i+n+g+)+|(a+m+a+z+i+n+g+)+)+\s+(w+o+r+k+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // greetings. I really enjoy your content and find it enjoyable to watch. I recommend that you continue your outstanding work. SeemsGood SeemsGood (PART 2)
      //console.log("Test 63"),
      /((h+e+y)+|(h+e+l+o+)+|(h+i+)+|(h+o+w+d+y+)+)+\,*\s+((n+i+c+e+)+|(m+a+t+e+)+|(b+u+d+y*)+|(f+r+i*e+n+d*)+)+\,*\s*\,*((m+e+t+i+n+g+)+|(s+t+r+[e*a*]*m+i*n*g*e*r*s*)+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s*\,*(\s*a+n+d+)*\s*(h+o+w+)+\s+(i+s+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)\s+(s+t+r+[e*a*]*m+i*n*g*e*r*s*)+\s+(g+o+i+n+g*)+(\s*\w+)*\s+(s+o+)+\s+(f+a+r+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // hello nice meeting you and how is your streaming going on so far
      //console.log("Test 64"),
      /((h+e+y)+|(h+e+l+o+)+|(h+i+)+|(h+o+w+d+y+)+)+\,*\s+((n+i+c+e+)+|(m+a+t+e+)+|(b+u+d+y*)+|(f+r+i*e+n+d*)+)+\,*\s*\,*(n+i+c+e+)*\s+((m+e+t+i+n+g+)+|(s+t+r+[e*a*]*m+i*n*g*e*r*s*)+)+\s*(\w*)\s*(n+o+t+i+c+e+d*)+\s+(((s+o+m+e+)+|(s+m+o+e+)+)\s*(t+h+i+n+[kg]*)+)+\s*(\s*\w+)\s*((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+((s+t+r+m+)+|(s+t+r+e+a+m+)+|(s+t+r+a+e+m+)+|(s+t+r+e+m+)+|(s+t+r+a+m+)+|(c+h+a+n+e+l+)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Hi mate nice streaming I noticed something on your channel that I think needs to be amended. I’d love to chat with you more about it on Discord. It would be a great opportunity to discuss the issue in more detail and to come up with a solution together. Would you be willing to chat with me on Discord? My username is Diablous#8216 (PART 1)
      //console.log("Test 65"),
      /((\w+[\'\’]+d+)+\s+)*(l+[ou]+v+e*)+(\s+t+o+)*\s+((c+h+a+t)+|(a+d+)+|(t+a+l+k+)+)+\s+(w+i+t+h*)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+(\s*m+o+r+e+)*\s+(a*b+o+u+t*)+(\s+i+t+)*(\s*\w+)\s+(d+[\s\.\,\-\_\+\=\\\/]*[1i]+[\s\.\,\-\_\+\=\\\/]*s+[\s\.\,\-\_\+\=\\\/]*c+[\s\.\,\-\_\+\=\\\/]*[0o]+[\s\.\,\-\_\+\=\\\/]*r*[\s\.\,\-\_\+\=\\\/]*d*)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Hi mate nice streaming I noticed something on your channel that I think needs to be amended. I’d love to chat with you more about it on Discord. It would be a great opportunity to discuss the issue in more detail and to come up with a solution together. Would you be willing to chat with me on Discord? My username is Diablous#8216 (PART 2)
      //console.log("Test 66"),
      ...
      //console.log("Test 68"),
      /(((w+o+u+l+d+)+|([\'\’]d)+)+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+(\s+(b+e+)+)*\s+(w+i+l+i*n*g*)+(\s+t+o+)*\s+((c+h+a+t)+|(a+d+)+|(t+a+l+k+)+)+\s+(w+i+t+h*)+\s+(m+e+)+(\s*(\s*\w+)\s*(d+[\s\.\,\-\_\+\=\\\/]*[1i]+[\s\.\,\-\_\+\=\\\/]*s+[\s\.\,\-\_\+\=\\\/]*c+[\s\.\,\-\_\+\=\\\/]*[0o]+[\s\.\,\-\_\+\=\\\/]*r*[\s\.\,\-\_\+\=\\\/]*d*)+)*/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Hi mate nice streaming I noticed something on your channel that I think needs to be amended. I’d love to chat with you more about it on Discord. It would be a great opportunity to discuss the issue in more detail and to come up with a solution together. Would you be willing to chat with me on Discord? My username is Diablous#8216 (PART 5)
      //console.log("Test 69"),
      /((h+e+y)+|(h+e+l+o+)+|(h+i+)+|(h+o+w+d+y+)+)+\,*\s+((n+i+c+e+)+|(m+a+t+e+)+|(b+u+d+y*)+|(f+r+i*e+n+d*)+)+\,*\s*\,*((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)*\s+((m+e+t+i+n+g+)+|(s+t+r+[e*a*]*m+i*n*g*e*r*s*)+)+\s+(p+r+e+t+y+)+\s+(c+o+l+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Howdy mate, You stream pretty cool that’s why I followed you. I will like to make you a friend and be a fan, if you don’t mind Kindly chat me on Discord, my Discord username is markk_2 (PART 1)
      //console.log("Test 70"),
      /((h+e+y)+|(h+e+l+o+)+|(h+i+)+|(h+o+w+d+y+)+)+\,*\s+((n+i+c+e+)+|(m+a+t+e+)+|(b+u+d+y*)+|(f+r+i*e+n+d*)+)+\,*\s*\,*((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)*\s+((m+e+t+i+n+g+)+|(s+t+r+[e*a*]*m+i*n*g*e*r*s*)+)+\s+(p+r+e+t+y+)+\s+(c+o+l+)+\,*\s+\,*(t+h+a+t+[\'\’]*\s*[IiSs]*)+\s+(w+h+y+)+\s*(\w*)*\s*(f+[o0]+[li1\|]+[o0]+w+\w*)+\s*((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)*/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Howdy mate, You stream pretty cool that’s why I followed you. I will like to make you a friend and be a fan, if you don’t mind Kindly chat me on Discord, my Discord username is markk_2 (PART 2)
      //console.log("Test 71"),
      ///(\w*)*\s*(w+i+l+)+\s*((l+i+k+e+)+|(l+[ou]+v+e*)+)+\s+(t+o+)+\s+((m+a+k+e*)+|(b+e+c*o*m*e*)+)+\s*((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)*\s*(\w*)*\s+(f+r+i*e+n+d*)+(\s+(a+n+d+)+\s+((m+a+k+e*)+|(b+e+c*o*m*e*)+)+\s*(\w*)*\s+(f+a+n+s*)+)*/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Howdy mate, You stream pretty cool that’s why I followed you. I will like to make you a friend and be a fan, if you don’t mind Kindly chat me on Discord, my Discord username is markk_2 (PART 3)
      //console.log("Test 72"),
      /(i+f+)+\s*((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)*\s+(d+o+n+[\'\’]*t+)+\s+(m+i+n+d+)+\s*\,*\s*(k+i+n+d+l+y+)*\s+((c+h+a+t)+|(a+d+)+|(t+a+l+k+)+)+\s*(m+e+)*\s+(o+n+)+\s+(d+[\s\.\,\-\_\+\=\\\/]*[1i]+[\s\.\,\-\_\+\=\\\/]*s+[\s\.\,\-\_\+\=\\\/]*c+[\s\.\,\-\_\+\=\\\/]*[0o]+[\s\.\,\-\_\+\=\\\/]*r*[\s\.\,\-\_\+\=\\\/]*d*)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Howdy mate, You stream pretty cool that’s why I followed you. I will like to make you a friend and be a fan, if you don’t mind Kindly chat me on Discord, my Discord username is markk_2 (PART 4)
      //console.log("Test 73"),
      /((h+e+y)+|(h+e+l+o+)+|(h+i+)+|(h+o+w+d+y+)+)+\,*\s+((n+i+c+e+)+|(m+a+t+e+)+|(b+u+d+y*)+|(f+r+i*e+n+d*)+)+\,*\s*\,*(\w*)\s*(r+e+a+l+y+)+\s+(e+n+j+o+y+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+((c+o+n+t+e+n+t+)+|(s+t+r+[e*a*]*m+i*n*g*e*r*s*)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Hey, mate, I really enjoy your streams,you stream pretty cool and I love it . I'd love to be part of your fan community. Could you add me on Discord? My username 👉👉👉ayofe_1 (PART 1)
      //console.log("Test 74"),
      /((h+e+y)+|(h+e+l+o+)+|(h+i+)+|(h+o+w+d+y+)+)+\,*\s+((n+i+c+e+)+|(m+a+t+e+)+|(b+u+d+y*)+|(f+r+i*e+n+d*)+)+\,*\s*\,*((\w*)\s*(r+e+a+l+y+)+\s+(e+n+j+o+y+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+((c+o+n+t+e+n+t+)+|(s+t+r+[e*a*]*m+i*n*g*e*r*s*)+)+\s*\,*\s*)*((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)*\s+((m+e+t+i+n+g+)+|(s+t+r+[e*a*]*m+i*n*g*e*r*s*)+)+\s+(p+r+e+t+y+)+\s+(c+o+l+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Hey, mate, I really enjoy your streams,you stream pretty cool and I love it . I'd love to be part of your fan community. Could you add me on Discord? My username 👉👉👉ayofe_1 (PART 2)
      //console.log("Test 75"),
      /((h+e+y)+|(h+e+l+o+)+|(h+i+)+|(h+o+w+d+y+)+)+\,*\s+((n+i+c+e+)+|(m+a+t+e+)+|(b+u+d+y*)+|(f+r+i*e+n+d*)+)+\,*\s*\,*((\w*)\s*(r+e+a+l+y+)+\s+(e+n+j+o+y+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+((c+o+n+t+e+n+t+)+|(s+t+r+[e*a*]*m+i*n*g*e*r*s*)+)+\s*\,*\s*)*((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)*\s+((m+e+t+i+n+g+)+|(s+t+r+[e*a*]*m+i*n*g*e*r*s*)+)+\s+(p+r+e+t+y+)+\s+(c+o+l+)+\s*(a+n+d+)+\s*(\w*)\s*((l+i+k+e+)+|(l+[ou]+v+e*)+)+\s*(i+t+)*/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Hey, mate, I really enjoy your streams,you stream pretty cool and I love it . I'd love to be part of your fan community. Could you add me on Discord? My username 👉👉👉ayofe_1 (PART 3)
      //console.log("Test 76"),
      ///(\w*)*\s*[\'\’]*\s*(\w*)*\s*((l+i+k+e+)+|(l+[ou]+v+e*)+)+\s+(t+o+)+\s+((m+a+k+e*)+|(b+e+c*o*m*e*)+)+\s+\w*\s*((p+a+r+t+)+|(m+e+m+b+e+r+)+)+\s*(\w*)\s*((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)*\s*(f+a+n+s*)\s*(c+o+m+u+n+i+t+y+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Hey, mate, I really enjoy your streams,you stream pretty cool and I love it . I'd love to be part of your fan community. Could you add me on Discord? My username 👉👉👉ayofe_1 (PART 4)
      //console.log("Test 77"),
      ///(c+o+u+l+d+)*\s*((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)*\s*((c+h+a+t)+|(a+d+)+|(t+a+l+k+)+)+\s*(m+e+)*\s+(o+n+)+\s+(d+[\s\.\,\-\_\+\=\\\/]*[1i]+[\s\.\,\-\_\+\=\\\/]*s+[\s\.\,\-\_\+\=\\\/]*c+[\s\.\,\-\_\+\=\\\/]*[0o]+[\s\.\,\-\_\+\=\\\/]*r*[\s\.\,\-\_\+\=\\\/]*d*)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Hey, mate, I really enjoy your streams,you stream pretty cool and I love it . I'd love to be part of your fan community. Could you add me on Discord? My username 👉👉👉ayofe_1 (PART 5)
      //console.log("Test 78"),
      /(m+y+)+\s*(d+[\s\.\,\-\_\+\=\\\/]*[1i]+[\s\.\,\-\_\+\=\\\/]*s+[\s\.\,\-\_\+\=\\\/]*c+[\s\.\,\-\_\+\=\\\/]*[0o]+[\s\.\,\-\_\+\=\\\/]*r*[\s\.\,\-\_\+\=\\\/]*d*)*\s*(u+s+e+r+)+\s*(n+a+m+e+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Hey, mate, I really enjoy your streams,you stream pretty cool and I love it . I'd love to be part of your fan community. Could you add me on Discord? My username 👉👉👉ayofe_1 (PART 6) (Do Not Use, Could cause false positives)
      //console.log("Test 79"),
      ...
      //console.log("Test 93"),
      /(h+i+)*\s*(((I+)+\s+(a+m+)+)+|((I+'+m+)+)+)+\s+(a)+\s+(s+m+[aeiouy]+l+)+\s+(s+t+r+[e*a*]*m+i*n*g*e*r*s*)+(\s+(b+y+)+\s+(t+h+e+)+)*\s+(n+a+m+e*d*)+\s+([\w\-\_]+)+\s+(g+i+v+e+)+(\s+(m+e+)+)*\s+(a+)+\s+(f+[o0]+[li1\|]+[o0]+w+\w*)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Hi I am a small streamer by the name XsaveXgoodX give me a follow I'm live rn I'm 19 and playing black ops 3 it would be much appreciated (Is this even a spam bot? I'm not sure)
      //console.log("Test 94"),
      /(((c+h*e+[ck]+)+)+(\s+((m+y+)+)+)*\s+((l+i+v+e+)+)+\s+((g+i+v+e+\s*a*w+a+y+)+)+\s+((t+w+[li1\!\|]+t+c+h+s*)+)+\s*((f+[o0]+[li1\|]+[o0]+w+\w*)+)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Ceck my live giveaway twitch followers
      //console.log("Test 95"),
      /((b+u+y+)+|(f+r+e+)+|(t+o+p+)+|(b+e+s+t+)+|(c+h+e+a+p+)+|(g+e+t+)+)+\s+((v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+\s*([\w\,]*)*\s*((v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Best Viewers and Followers on StreamBoo .com (  u.to/yp_QIA )
      //console.log("Test 96"),
      /((b+u+y+)+|(f+r+e+)+|(t+o+p+)+|(b+e+s+t+)+|(c+h+e+a+p+)+|(g+e+t+)+)+\s+((v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+\s*([\w\,]*)*/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // [Wed 2024-05-29T15:16:56Z]  <rickyboi999838893> Best viewers on cutt.ly/Pey3i71C // [Sat 2026-01-24T01:45:15Z]  <scaredpluralcse> @whataboutgaminglive Top viewers smmtop55.ru
      //console.log("Test 97"),
      /((h+i+[gq]+h+)+\s+(q+u+a+l+i+t+y+)\s*([\w\,]*)*\s*)*((b+u+y+)+|(f+r+e+)+|(t+o+p+)+|(b+e+s+t+)+|(c+h+e+a+p+)+|(g+e+t+)+)+\s+((v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+\s*([\w\,]*)*\s*((v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // [Mon 2024-06-10T19:14:03Z]  <fafixfan> Hiqh quality and Cheap Viewers on  u.to/vRi7IA
      //console.log("Test 98"),
      /((h+i+[gq]+h+)+\s+(q+u+a+l+i+t+y+)\s*([\w\,]*)*\s*)*((b+u+y+)+|(f+r+e+)+|(t+o+p+)+|(b+e+s+t+)+|(c+h+e+a+p+)+|(g+e+t+)+)+\s+((v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+\s*([\w\,]*)*/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // [Mon 2024-06-10T19:14:03Z]  <fafixfan> Hiqh quality and Cheap Viewers on  u.to/vRi7IA // [Sat 2026-01-24T01:45:15Z]  <scaredpluralcse> @whataboutgaminglive Top viewers smmtop55.ru
      //console.log("Test 99"),
      /((v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+\s*([\w\,]*)*\s*((v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Best Viewers and Followers on StreamBoo .com (  u.to/yp_QIA )
      //console.log("Test 100"),
      /((v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+\s*([\w\,]*)*/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // [Wed 2024-05-29T15:16:56Z]  <rickyboi999838893> Best viewers on cutt.ly/Pey3i71C // [Sat 2026-01-24T01:45:15Z]  <scaredpluralcse> @whataboutgaminglive Top viewers smmtop55.ru // [Mon 2026-02-02T16:37:15Z]  <contaminatedfirevecfyj> Viewers smmboost2.online  @axRCmIbO
      //console.log("Test 101"),
      /((h+i+[gq]+h+)+\s+(q+u+a+l+i+t+y+)\s*([\w\,]*)*\s*)*((v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+\s*([\w\,]*)*\s*((v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // [Mon 2024-06-10T19:14:03Z]  <fafixfan> Hiqh quality and Cheap Viewers on  u.to/vRi7IA
      //console.log("Test 102"),
      /((h+i+[gq]+h+)+\s+(q+u+a+l+i+t+y+)\s*([\w\,]*)*\s*)*((v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+\s*([\w\,]*)*/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // [Mon 2024-06-10T19:14:03Z]  <fafixfan> Hiqh quality and Cheap Viewers on  u.to/vRi7IA // [Sat 2026-01-24T01:45:15Z]  <scaredpluralcse> @whataboutgaminglive Top viewers smmtop55.ru // [Mon 2026-02-02T16:37:15Z]  <contaminatedfirevecfyj> Viewers smmboost2.online  @axRCmIbO
      ...
      /((l+e+t+[\'\’]*\s*[UuSs]*)*\s*(\w*)\s*((c+o+n+[te]*a*c+t+\w*)+|(c+h+i+l+\w*)+)+\s*(\w*)\s*(\w*)\s*(\w*)\s*(d+[\s\.\,\-\_\+\=\\\/]*[1i]+[\s\.\,\-\_\+\=\\\/]*s+[\s\.\,\-\_\+\=\\\/]*c+[\s\.\,\-\_\+\=\\\/]*[0o]+[\s\.\,\-\_\+\=\\\/]*r*[\s\.\,\-\_\+\=\\\/]*d*)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // [Sat 2024-11-09T15:38:46Z]  <wumight4> Hey streamer 👋,I’ve been really enjoying your content, which is why I’m part of your squad. I noticed you’re facing some challenges with growing your channel and leveling up. I’d love to share ideas and help elevate your stream. Let’s connect on Discord: Femight7. (Let's connect on Discord) / (Let's stay connected on Di  s c o r d) // [Sat 2026-04-25T01:51:10Z] <xacegurux> Caught a bit of your stréam. Whén do you usually go livé? Can I have your stréam time to tuné in néxt time PopNemo  ! Lét chill about it on d.i s c0.r.d 👍 aceguru01, wàiting for your réquést
      //console.log("Test 105"),
      /((g+r+o+w+\w+)+\s*((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s*(\w*)\s*(c+h+a+n+e+l+)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // [Sat 2024-11-09T15:38:46Z]  <wumight4> Hey streamer 👋,I’ve been really enjoying your content, which is why I’m part of your squad. I noticed you’re facing some challenges with growing your channel and leveling up. I’d love to share ideas and help elevate your stream. Let’s connect on Discord: Femight7. (growing your channel)
      //console.log("Test 106")
      /((l+[ou]+v+e*)+\s*(\w*)\s*(e*\s*n+\s*e*\s*r+\s*g+\s*y*)+\s*(\w*)\s*(p+o+s+i+t+\w+)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // [Sat 2026-01-17T00:09:02Z] <streeze_4> Love the energy and positivity on your stream! 🤍 You're an inspiration! 🙌 Let's stay connected on Di  s c o r d @ beky_89 (Love the energy and positivity) (PART 1)
      //console.log("Test 107"),
      /((l+[ou]+v+e*)+\s*(\w*)\s*(e*\s*n+\s*e*\s*r+\s*g+\s*y*)+\s*(\w*)\s*(p+o+s+i+t+\w+)+\s*(\w*)\s*(\w*)\s*(s+t+r+[e*a*]*m+i*n*g*e*r*s*)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // [Sat 2026-01-17T00:09:02Z] <streeze_4> Love the energy and positivity on your stream! 🤍 You're an inspiration! 🙌 Let's stay connected on Di  s c o r d @ beky_89 (Love the energy and positivity on your stream) (PART 2)
      //console.log("Test 108"),
      /(((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s*(\w*)\s*(i+n+s+p+[aeiouy]*r*a*t*i*o*n*)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // [Sat 2026-01-17T00:09:02Z] <streeze_4> Love the energy and positivity on your stream! 🤍 You're an inspiration! 🙌 Let's stay connected on Di  s c o r d @ beky_89 (You're an inspiration) (PART 3)
      ...
      // [Tue 2026-08-25T00:41:40Z] <louvre_42> Yo 🤗, respect the hustle. I just dropped a follow before heading out!
      // [Tue 2026-08-25T00:41:43Z] <louvre_42> If you want to grow, add FORSEN_N on Discord and tell him WALEX sent you. He’s a massive streamer who helps people get real viewers and active chatters
      /((i+f+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+((w+a+n+\'*t+)+|(w+a+n+\'*a+)+)+\s*(t+o+)*\s+(g+r+o+w+)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // [Tue 2026-08-25T00:41:43Z] <louvre_42> If you want to grow, add FORSEN_N on Discord and tell him WALEX sent you. He’s a massive streamer who helps people get real viewers and active chatters (Part 1 "If you want to grow")
      /((h+i+[gq]+h+)+\s+(q+u+a+l+i+t+y+)\s*([\w\,]*)*\s*)*((a+c+t+i+v+e+)+|(r+e+a+l+)+|(b+u+y+)+|(f+r+e+)+|(t+o+p+)+|(b+e+s+t+)+|(c+h+e+a+p+)+|(g+e+t+)+)+\s+((c+h+a+t+\w*)+|(v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+\s*([\w\,]*)*\s*((a+c+t+i+v+e+)+|(r+e+a+l+)+|(b+u+y+)+|(f+r+e+)+|(t+o+p+)+|(b+e+s+t+)+|(c+h+e+a+p+)+|(g+e+t+)+)*\s*((c+h+a+t+\w*)+|(v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // [Tue 2026-08-25T00:41:43Z] <louvre_42> If you want to grow, add FORSEN_N on Discord and tell him WALEX sent you. He’s a massive streamer who helps people get real viewers and active chatters (Part 2 "real viewers and active chatters")
      /((h+i+[gq]+h+)+\s+(q+u+a+l+i+t+y+)\s*([\w\,]*)*\s*)*((a+c+t+i+v+e+)+|(r+e+a+l+)+|(b+u+y+)+|(f+r+e+)+|(t+o+p+)+|(b+e+s+t+)+|(c+h+e+a+p+)+|(g+e+t+)+)+\s+((c+h+a+t+\w*)+|(v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+\s*([\w\,]*)*/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // [Tue 2026-08-25T00:41:43Z] <louvre_42> If you want to grow, add FORSEN_N on Discord and tell him WALEX sent you. He’s a massive streamer who helps people get real viewers and active chatters (Part 3 "real viewers and" "active chatters")
      /((a+c+t+i+v+e+)+|(r+e+a+l+)+|(b+u+y+)+|(f+r+e+)+|(t+o+p+)+|(b+e+s+t+)+|(c+h+e+a+p+)+|(g+e+t+)+)+\s+((c+h+a+t+\w*)+|(v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+\s*([\w\,]*)*\s*((a+c+t+i+v+e+)+|(r+e+a+l+)+|(b+u+y+)+|(f+r+e+)+|(t+o+p+)+|(b+e+s+t+)+|(c+h+e+a+p+)+|(g+e+t+)+)*\s*((c+h+a+t+\w*)+|(v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // [Tue 2026-08-25T00:41:43Z] <louvre_42> If you want to grow, add FORSEN_N on Discord and tell him WALEX sent you. He’s a massive streamer who helps people get real viewers and active chatters (Part 4 "real viewers and active chatters")
      /((a+c+t+i+v+e+)+|(r+e+a+l+)+|(b+u+y+)+|(f+r+e+)+|(t+o+p+)+|(b+e+s+t+)+|(c+h+e+a+p+)+|(g+e+t+)+)+\s+((c+h+a+t+\w*)+|(v+i+e+w+\w*)+|(s+u+b+\w*)+|(f+[o0]+[li1\|]+[o0]+w+\w*)+)+\s*([\w\,]*)*\s*/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")) // [Tue 2026-08-25T00:41:43Z] <louvre_42> If you want to grow, add FORSEN_N on Discord and tell him WALEX sent you. He’s a massive streamer who helps people get real viewers and active chatters (Part 5 "real viewers and" "active chatters")
    ];
    ...
    let multiMessageSpamBotTypeB = [
      ...
      /(t+a+k+e+)+\s+(\w+)+\s+(l+o+k+)+\s+((a*t*|i*n*|o*n*)*\s*(t+h+e+)+)+\s+(u+r+l+)+\s+(\w*)+\s+(m+y+)+\s+(a+c+o+u+n+t+\W*\w*)+\s+(i+m+a+g+e+)+\s+(p+r+o+b+a+b+l+y+)+\s+(t+h+e+)+\s+(((b+u+y+)+|(f+r+e+)+|(t+o+p+)+|(b+e+s+t+)+|(c+h+e+a+p+)+|(g+e+t+)+)+\W*)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, ""))
    ];
    let multiMessageSpamBotTypeC = [
      ...
      /(((h[oi]w)+|(hw[oi])+)+\W*i*s+\s*((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s*(d+a+y+)+\s*(g+o+i+n+g*)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")),
      ...
      /((g+i+v+e*)+\s*(m+e+)*\s*(\w*)*\s+(d+[\s\.\,\-\_\+\=\\\/]*[1i]+[\s\.\,\-\_\+\=\\\/]*s+[\s\.\,\-\_\+\=\\\/]*c+[\s\.\,\-\_\+\=\\\/]*[0o]+[\s\.\,\-\_\+\=\\\/]*r*[\s\.\,\-\_\+\=\\\/]*d*)+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, ""))
    ];
    let multiMessageSpamBotTypeD = [
      /(h+e+l+[aeiou]+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // helloi
      /((h+o+w+)+|(h+w+o+)+)+\s*([aeiou]*r+[aeiou]*)*\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // How are you ?
      /(c+a+n+)+\s*(\w*)\s*(m+a+k+e+)+\s+(a+r+t+s*)+\s+(f+o+r*)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+(c+h+a+n+e+l+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // can I make arts for your channel
      /(s+e+n+[dt]+)+\s+(m+e+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+(d+[\s\.\,\-\_\+\=\\\/]*[1i]+[\s\.\,\-\_\+\=\\\/]*s+[\s\.\,\-\_\+\=\\\/]*c+[\s\.\,\-\_\+\=\\\/]*[0o]+[\s\.\,\-\_\+\=\\\/]*r*[\s\.\,\-\_\+\=\\\/]*d*)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // Send me your discord
      /(d+[\s\.\,\-\_\+\=\\\/]*[1i]+[\s\.\,\-\_\+\=\\\/]*s+[\s\.\,\-\_\+\=\\\/]*c+[\s\.\,\-\_\+\=\\\/]*[0o]+[\s\.\,\-\_\+\=\\\/]*r*[\s\.\,\-\_\+\=\\\/]*d*)+\s+(s+e+n+[dt]+)+\s+(m+e+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+(r+e+q+u+e+s+t+)+\s+(s+o+)+\s*(\w*)\s*(c+a+n+)+\s+(s+h+a+r+e+)+\s+(m+y+)+\s+(w+o+r+k+)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")), // alisadaniel its ,my discord sent me your request so i can share my work <3
      /(t+y+p+e*)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+(d+[\s\.\,\-\_\+\=\\\/]*[1i]+[\s\.\,\-\_\+\=\\\/]*s+[\s\.\,\-\_\+\=\\\/]*c+[\s\.\,\-\_\+\=\\\/]*[0o]+[\s\.\,\-\_\+\=\\\/]*r*[\s\.\,\-\_\+\=\\\/]*d*)+/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")) // type your discord ?
    ];
    let multiMessageSpamBotTypeE = [
      ...
      /(h+a+v+e+)+\s*(\w*)*\s*(i+m+p+o+r+t+a+n+t+)+\s+(t+a+l+k+)+\s+(\w*b+o+u+t+)+\s+((y+o+)+|(u+\s*r*)+\s*\w*\s*[\'\’]*\s*\w*)+\s+(c+h+a+n+e+l+)+\s*(\w*)\s*(c+o+n+[te]*a*c+t+\w*)+\s+(m+e+)(\s*(\s*\w+)\s*(d+[\s\.\,\-\_\+\=\\\/]*[1i]+[\s\.\,\-\_\+\=\\\/]*s+[\s\.\,\-\_\+\=\\\/]*c+[\s\.\,\-\_\+\=\\\/]*[0o]+[\s\.\,\-\_\+\=\\\/]*r*[\s\.\,\-\_\+\=\\\/]*d*)+)*/ig.test(replaceCyrillicsWithLatin.normalize("NFD").replace(/[\u007E-\uFFFF]+/ig, "")) // I have an important talk about your channel kindly contact me on discord. Pearl0307
    ];
    ...
    */
    let checkFollowAge = /^[!\"#$%&'()*+,\-./:;%=%?@\[\\\]^_`{|}~¡¦¨«¬­¯°±»½⅔¾⅝⅞∅ⁿ№★†‡‹›¿‰℅æßçñ¹⅓¼⅛²⅜³⁴₱€¢£¥—–·„“”‚‘’•√π÷×¶∆′″§Π♣♠♥♪♦∞≠≈©®™✓‛‟❛❜❝❞❟❠❮❯⹂〝〞〟＂🙶🙷🙸󠀢⍻✅✔𐄂🗸‱]+\s*((f+[o0]+[li1\|]+[o0]+w+\w*\s*a+g+e+)+|(w+a+t+c+h+\s*(uptim[er]|upti[er]m|up\s*tim[er]|up\s*ti[er]m|tim[er]|ti[er]m)+)+)+/ig.test(originalMessage);
